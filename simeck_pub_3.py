...
block_si = block1_si #ganti sesuai dgn kunci yg diperlukan

cipher = Simeck(master_key=key, key_size=key_si, block_size=block_si)
...
for i in range (10) :
    ...
    messc = cipher.encrypt_dt(mess,block_si,key_si,mess_si)
