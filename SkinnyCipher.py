...
class SkinnyCipher:
    ...
    def __init__(self, key, key_size=128, block_size=128, mode='ECB', init=0, counter=0):
        ...
        for z in range(self.tweak_size):
            ...
            tweakkey = self.new_method(sub_key)
    ...
    def encrypt_dt(self,msg):    
        ...
        #cipher = SkinnyCipher(key, key_size, block_size, mode='ECB')
        message ={}
        enc2=[]
        i=0
        for r in range(1):
        ...
        pencatatan(r, mess,date_now, ciphertxt, encryption_periode,self.block_size,self.key_size)
        return(ciphertxt)
        
    def decrypt_dt(self, cipher_txt):   
        # Record the start time
        start = timeit.default_timer()
        ...
        # Make the data record
        pencatatan(r, mess,date_now, plaintxt, encryption_periode,self.block_size,self.key_size)
        print()        
        return(plaintxt)
        
def pencatatan(r, mess,date_now, ciphertxt, encryption_periode,block_size,key_size):
    f = open('Skinny_enc.csv', 'a')
